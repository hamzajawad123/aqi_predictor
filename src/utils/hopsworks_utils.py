...
def get_or_create_feature_group(fs, df_for_schema=None):
    """Open the feature group. Fail if this version has no delta columns."""
    print(
...
def get_or_create_feature_view(fs, fg, label_col: str = "aqi_delta_72h"):
    """Saved query on the feature group. Default label is 72h delta."""
    query = fg.select_all()
...
if __name__ == "__main__":
    # Make the feature view after the first backfill.
